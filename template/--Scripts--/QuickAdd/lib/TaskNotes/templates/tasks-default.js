/**
 * @param {string[]} [filters] - Additional filters to add to the top-level `and` block.
 * @returns {string}
 */
function tasksDefault(filters = []) {
  const extraFilters = filters.length
